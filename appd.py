...
LOGO_SVG = """<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
  <polygon points="18,2 34,10 34,26 18,34 2,26 2,10" fill="#1b1b2f" stroke="#d4a843" stroke-width="1.4"/>
  <polygon points="18,7 29,13 29,23 18,29 7,23 7,13" fill="#d4a843" opacity="0.18"/>
  <polygon points="18,12 24,15.5 24,22.5 18,26 12,22.5 12,15.5" fill="#d4a843" opacity="0.55"/>
  <circle cx="18" cy="18" r="3" fill="#f0c866"/>
</svg>"""

LOGO_SVG_GATE = """<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
  <polygon points="28,3 53,15.5 53,40.5 28,53 3,40.5 3,15.5" fill="#12122a" stroke="#d4a843" stroke-width="1.8"/>
  <polygon points="28,11 45,20.5 45,35.5 28,45 11,35.5 11,20.5" fill="#d4a843" opacity="0.15"/>
  <polygon points="28,18 39,24 39,32 28,38 17,32 17,24" fill="#d4a843" opacity="0.5"/>
  <circle cx="28" cy="28" r="5" fill="#f0c866"/>
