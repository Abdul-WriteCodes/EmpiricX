...
def smart_truncate(text: str, max_tokens: int = 12000) -> str:
    ...
    # Always keep the very start of the document — this is where title,
    # authors, affiliations, and publication year live. Without this,
    # truncation below (which starts matching at "abstract") silently
    # drops the byline and the model has no way to know the authors.
    header = text[:1500]
